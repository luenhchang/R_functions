# ---------------------------------------------------------------------------------------
# Program       : function_add_text_to_9_locations_of_a_figure.R
# modified from : 
...
# Purpose       : add text aligned to 9 corners within a plot
#----------------------------------------------------------------------------------------
# run dependency    : 
# input files	      : 
#----------------------------------------------------------------------------------------
...
fig_label("A long sentence \nAnother long sentence", pos="topleft", cex=2, col="skyblue",region="plot")